...
const INVESTMENT: 'INVESTMENT' = 'INVESTMENT';

// return of investment (transfer from yet unknown account to investors' wallets)
const INVESTMENT_RETURN: 'INVESTMENT_RETURN' = 'INVESTMENT_RETURN';

// acquisition of an investment on SMP (debit)
const SMP_BUY: 'SMP_BUY' = 'SMP_BUY';

// selling of an investment on SMP (credit)
const SMP_SELL: 'SMP_SELL' = 'SMP_SELL';

// transfer of investment acquisition price from CREDIT to JUMBO (credit & debit)
const SMP_PRICE_TRANSFER: 'SMP_PRICE_TRANSFER' = 'SMP_PRICE_TRANSFER';

// fee for selling an investment (debit)
const SMP_SALE_FEE: 'SMP_SALE_FEE' = 'SMP_SALE_FEE';
...
const UNSPECIFIED_IN: 'UNSPECIFIED_IN' = 'UNSPECIFIED_IN';

// unspecified outgoing transaction
const UNSPECIFIED_OUT: 'UNSPECIFIED_OUT' = 'UNSPECIFIED_OUT';
